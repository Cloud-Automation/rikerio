...
let g:ale_cpp_gcc_options = '-Iinclude -Ibuild/debug/gtest-install/include -Ibuild/debug/include -Itest -Wall -pedantic -Wextra -Ibuild/debug/install/include -std=c++11'
